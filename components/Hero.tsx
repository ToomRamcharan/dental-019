        ...
        <div className="max-w-3xl">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-sm ml-2" style={{color: '#a855f7'}}>4.3 on Google</span>
            </div>
            ...
            <p className="text-xl mb-8 leading-relaxed" style={{color: '#64748b'}}>
              Experience world-class dental care at Om Dental Clinic. Expert dentists, modern technology, and compassionate care.
            </p>
